...
public class NumTC_LS extends baseClass_LS 
{
	LoginPage Lp;
	RegisterPage Rp;
	...
	@Test
	  public void validatingNumField() throws EncryptedDocumentException, InterruptedException, IOException
	  {
		  Rp.EnterNumber(utilityClass_LS.readFromExcel(3, 0));
